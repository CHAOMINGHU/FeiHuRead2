...
public class ReadChapter extends Activity implements AdapterView.OnItemClickListener
{
	private int i;
...
//			 list.add(map);
	...
	public void save(View v)
	{
    		...
    		Toast.makeText(ReadChapter.this,  "��"+list.size()+"��"+ "����ɹ�",Toast.LENGTH_LONG).show();
	...
	public void clear(View v)
	{
		...
		{
			Toast.makeText(ReadChapter.this, "������՟o�����", Toast.LENGTH_LONG).show();
			return;
		}
		for(int k=0;k<list.size();k++)
		{
		...
		isClear = true;
		Toast.makeText(ReadChapter.this, "�������ɹ�", Toast.LENGTH_LONG).show();
	}
	@Override
...
//		startActivity(intent);
	Toast.makeText(ReadChapter.this, position+"", Toast.LENGTH_LONG).show();
