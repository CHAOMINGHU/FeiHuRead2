package com.example.hcm.feihuread.popuwindow;
...
public class CustomPopWindow
{
	...
	private PopupWindow build()
	{
		...
		{
			mContentView = LayoutInflater.from(mContext).inflate(mResLayoutId,
					null);
		}
	...
	public static class PopupWindowBuilder
	{
		...
		public PopupWindowBuilder setTouchIntercepter(
				View.OnTouchListener touchIntercepter)
		{
