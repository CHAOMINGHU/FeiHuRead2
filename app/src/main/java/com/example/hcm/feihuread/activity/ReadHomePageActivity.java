...
public class ReadHomePageActivity extends Activity
{
			...
			case 1:
				...
				adapter.setOnItemClickListner(new MyRecyclerAdapter.OnItemClickListner() {
					...
					public void onItemClick(int position) {
						Toast.makeText(ReadHomePageActivity.this,"点击了"+position,Toast.LENGTH_SHORT).show();
					}

					@Override
					public void onItemLongClick(int position) {
						Toast.makeText(ReadHomePageActivity.this,"长按了"+list.get(position),Toast.LENGTH_SHORT).show();
					}
				});
				...
				case  2:
					...
					adapter.setOnItemClickListner(new MyRecyclerAdapter.OnItemClickListner() {
						@Override
						public void onItemClick(int position) {
							Toast.makeText(ReadHomePageActivity.this,"点击了"+list.get(position).get("title"),Toast.LENGTH_SHORT).show();
						}
